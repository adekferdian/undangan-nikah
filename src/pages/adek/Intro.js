                    ...
                    <div className="sixth"  id="time" >
                        ...
                        <div className="border-lokasi">
                            <div className="denah-lokasi">
                                ...
                                <img onClick={() => window.open("https://bit.ly/Lokasi-weeding-Mimi-Adek")} alt="" className="pin2" src="https://img.icons8.com/external-icongeek26-linear-colour-icongeek26/64/000000/external-location-user-interface-icongeek26-linear-colour-icongeek26.png"/>
                            </div>
                        </div>
                    </div>
                </div>
